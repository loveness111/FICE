...
def main():
    ...
    print("dfX2E first ten data:", dfX2E[:10])
    ...
    print("The accuracy of this method in simulating the prediction results of the black box model (random forest):", (class_count[cc_outcome] / sum(class_count.values())))
    '''

    print('r = %s --> %s -->%s' % (
    explanation[0][1], explanation[0][0], explanation[0][2]))
    ...
    precision = [1 - eval(v, explanation[0][0][dataset['class_name']]) for v in
                 y2E[covered]]
    print(precision)
